...
Local-First Conversational AI & Home Automation System

Purpose (Authoritative)

Delilah is a local-first, low-latency conversational AI system designed to operate reliably without cloud dependence, while allowing explicitly gated cloud fallback when required.

The system integrates:

Deterministic conversation orchestration

Structured system-of-record logging

Semantic memory (RAG) with strict policies

Tool execution with auditability

Future Mixture-of-Experts (MoE) routing

Future voice and home automation interfaces
